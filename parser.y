...
%token <tokenData> NUMCONST STRINGCONST CHARCONST BOOLCONST KEYWORD OP ID INC DEC ASGN ADDASGN SUBASS MULASS DIVASS LEQ GEQ NEQ INVALID
...
MULOP : INC                 { printf("Line %d Token: INC\n", $1->linenum); }
      ...
      | ADDASGN             { printf("Line %d Token: ADDASGN\n", $1->linenum); }
